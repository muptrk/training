      ...
      <div class="form-group">
        <div class="form-row">
          <div class="col-md-6">
            ...
            <input class="form-control" id="mobile" name="mobile" value="{{ old('mobile') }}" type="text" aria-describedby="nameHelp" placeholder="Enter mobile">
          ...
          <div class="col-md-6">
            ...
            <input class="form-control" id="age" name="age" value="{{ old('age') }}" type="text" aria-describedby="nameHelp" placeholder="Enter age">
            @if ($errors->has('age'))
      ...
      <div class="form-group">
        <div class="form-row">
          <div class="col-md-6">
            ...
            <input class="form-control" id="address" name="address" value="{{ old('address') }}" type="text" aria-describedby="nameHelp" placeholder="Enter address">
