      ...
      <div class="form-group">
        <div class="form-row">
          ...
          <div class="col-md-6">
            ...
            <input class="form-control" id="surname" name="surname" value="{{ old('surname') ? old('surname') : $item->surname }}" type="text" aria-describedby="surnameHelp" placeholder="Enter last name">
